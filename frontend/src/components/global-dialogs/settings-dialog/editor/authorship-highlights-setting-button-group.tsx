...
import { AuthorshipHighlightMode } from '../../../../redux/editor/types'
import { setEditorAuthorshipHighlightMode } from '../../../../redux/editor/methods'
...
export const AuthorshipHighlightModeSettingButtonGroup: React.FC = () => {
  ...
  const onButtonSelect = useCallback((newValue: AuthorshipHighlightMode) => {
    setEditorAuthorshipHighlightMode(newValue)
  }, [])
